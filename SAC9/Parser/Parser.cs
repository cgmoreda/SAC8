    ...
    static public class Parser
    {
                ...
                if (lexemes[left+1].type == TokenType.Ident)
                {
                    ...
                    else if (lexemes[2].type== TokenType.OpenBracket)
                    {
                        ...
                        if (lexemes[left+3].type == TokenType.Number)
                        {
                            ...
                            if (lexemes[left+4].type == TokenType.CloseBracket)
                            {
                                ...
                                else
                                {
                                    return new NoTermReturn
                                    {
                                        error =$"Expected ';' at line {lexemes[left+5].line} at column: {lexemes[left+5].column}\n",
                                        rightIndex = left+6,
                                        node = _node,
                                    };
                                }
                            ...
                            else
                            {
                                return new NoTermReturn
                                {
                                    error =$"Expected ']' at line {lexemes[left+4].line} at column: {lexemes[left+4].column}\n",
                                    rightIndex = left+5,
                                    node = _node,
                                };
                            }
                        ...
                        else
                        {
                            return new NoTermReturn
                            {
                                error =$"Expected Number at line {lexemes[left+3].line} at column: {lexemes[left+3].column}\n",
                                rightIndex = left+4,
                                node = _node,
                            };
                        }
                ...
                else
                {
                    ...
                    for (; left<lexemes.Count(); left++)
                    {
                        if (lexemes[left].type==TokenType.Simecolon)
                        {
                            return new NoTermReturn
                            {
                                error =$"Expected Identifier at line {line} at column: {column}\n",
                                rightIndex = left+1,
                                node = _node,
                            };
                        }
            ...
            else
            {
                ...
                for (; left<lexemes.Count(); left++)
                {
                    if (lexemes[left].type==TokenType.Simecolon)
                    {
                        return new NoTermReturn
                        {
                            error =$"Expected type-specifier at line {line} at column: {column}\n",
                            rightIndex = left+1,
                            node = _node,
                        };
                    }
                    ...
                    if (lexemes[left+2].type == TokenType.OpenPar)
                    {
                        ...
                        if (paramsRes.node!=null)
                        {
                            ...
                            if (lexemes[paramsRes.rightIndex].type == TokenType.ClosePar)
                            {
                                ...
                                NoTermReturn compoundStmtRes = CompoundStmt(paramsRes.rightIndex+1);
                                ...
                                else
                                {
                                    return new NoTermReturn
                                    {
                                        error =$"Expected compound statement at line {lexemes[paramsRes.rightIndex].line} at column: {lexemes[paramsRes.rightIndex].column}\n",
                            ...
                            else
                            {
                                return new NoTermReturn
                                {
                                    error =$"Expected close params at line {lexemes[paramsRes.rightIndex].line} at column: {lexemes[paramsRes.rightIndex].column}\n",
                                    rightIndex = paramsRes.rightIndex+1,
                                    node = _node,
                                };
                            }
                        ...
                        else
                        {
                            return new NoTermReturn
                            {
                                error =$"Expected params at line {lexemes[left+3].line} at column: {lexemes[left+3].column}\n",
                                rightIndex = left+4,
                                node = _node,
                            };
                        }
        ...
        static public NoTermReturn ParamList(int left)
        {
            ...
            if (lexemes[left].type!=TokenType.ClosePar)
            {
                ...
                if (paramRes.node!=null)
                {
                    ...
                    if (lexemes[left].type == TokenType.Comma)
                    {
                        ...
                        else
                        {
                            return new NoTermReturn
                            {
                                error =$"Expected paramList at line {lexemes[paramRes.rightIndex].line} at column: {lexemes[paramRes.rightIndex].column}\n",
                    ...
                    else
                    {
                        return new NoTermReturn
                        {
                            error =$"Expected ',' or ')' at line {lexemes[left].line} at column: {lexemes[left].column}\n",
                            rightIndex = left+1,
                            node = _node,
                        };
                    }
                ...
                else
                {
                    return new NoTermReturn
                    {
                        error =$"Expected param at line {lexemes[left].line} at column: {lexemes[left].column}\n",
                        rightIndex = left+1,
                        node = null,
                    };
                }   
        ...
        static public NoTermReturn CompoundStmt(int left)
        {
            ...
            if(noTermReturn.node!=null)
            {
                ...
                else
                {
                    return new NoTermReturn
                    {
                        error =$"Expected paranthaese at line {lexemes[noTermReturn.rightIndex].line} at column: {lexemes[noTermReturn.rightIndex].column}\n",
            ...
            if(noTermReturn1.node!=null)
            {
                ...
                else
                {
                    return new NoTermReturn
                    {
                        error =$"Expected paranthaese at line {lexemes[noTermReturn1.rightIndex].line} at column: {lexemes[noTermReturn1.rightIndex].column}\n",
        ...
        static public NoTermReturn LocalDeclarations(int left)
        {
            ...
            if (varDeclarationRes.node!=null)
            {
                ...
                NoTermReturn localDeclarationsRes = LocalDeclarations(varDeclarationRes.rightIndex);
        ...
        static public NoTermReturn ExpressionStmt(int left)
        {
            ...
            if (expressionRes.node!=null)
            {
                ...
                else
                {
                    return new NoTermReturn
                    {
                        error =$"Expected ';' at line {lexemes[expressionRes.rightIndex].line} at column: {lexemes[expressionRes.rightIndex].column}\n",
                        rightIndex = expressionRes.rightIndex+1,
                        node = _node,
                    };
                }
                        ...
                        if (lexemes[expressionRes.rightIndex].type == TokenType.ClosePar)
                        {
                            ...
                            if (statementRes.node!=null)
                            {
                                ...
                                if (lexemes[statementRes.rightIndex].type == TokenType.else_)
                                {
                                    ...
                                    NoTermReturn statementRes2 = Statement(statementRes.rightIndex+1);
                                    ...
                                    else
                                    {
                                        return new NoTermReturn
                                        {
                                            error =$"Expected statement at line {lexemes[statementRes.rightIndex].line} at column: {lexemes[statementRes.rightIndex].column}\n"
                                        };
                                    }
                                }
                            }
            ...
            if (lexemes[left].type == TokenType.while_)
            {
                ...
                if (lexemes[left+1].type == TokenType.OpenPar)
                {
                    ...
                    if (expressionRes.node!=null)
                    {
                        ...
                        if (lexemes[expressionRes.rightIndex].type == TokenType.ClosePar)
                        {
                            ...
                            else
                            {
                                return new NoTermReturn
                                {
                                    error =$"Expected statement at line {lexemes[expressionRes.rightIndex].line} at column: {lexemes[expressionRes.rightIndex].column}\n",
                                    rightIndex = expressionRes.rightIndex+1,
                                    node = _node,
                                };
                            }
                    ...
                    else
                    {
                        return new NoTermReturn
                        {
                            error =$"Expected expression at line {lexemes[left+2].line} at column: {lexemes}"
                        };
                    }
                }
            }
            ...
            if (lexemes[left].type == TokenType.return_)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        return new NoTermReturn
                        {
                            error =$"Expected expression at line {lexemes[left+1].line} at column: {lexemes[left+1].column}\n",
                            rightIndex = left+2,
                            node = _node,
                        };
                    }
            ...
            if (varRes.node!=null)
            {
                ...
                if (lexemes[varRes.rightIndex].type == TokenType.equal_)
                {
                    ...
                    else
                    {
                        return new NoTermReturn
                        {
                            error =$"Expected expression at line {lexemes[varRes.rightIndex].line} at column: {lexemes[varRes.rightIndex].column}\n",
            ...
            if (lexemes[left].type == TokenType.Ident)
            {
                ...
                if (lexemes[left+1].type == TokenType.OpenBracket)
                {
                    ...
                    if (expressionRes.node!=null)
                    {
                        ...
                        if (lexemes[expressionRes.rightIndex].type == TokenType.CloseBracket)
                        {
                            _node.Childs.Add(new Node()
                            {
                                Type = lexemes[expressionRes.rightIndex].value,
                    ...
                    else
                    {
                        return new NoTermReturn
                        {
                            error =$"Expected expression at line {lexemes[left+2].line} at column: {lexemes[left+2].column}\n",
                            rightIndex = left+3,
                            node = _node,
                        };
                    }
            ...
            if (addRes.node!=null)
            {
                ...
                if (relOps(addRes.rightIndex))
                {
                    ...
                    else
                    {
                        return new NoTermReturn
                        {
                            error =$"Expected AdditiveExpression at line {lexemes[addRes.rightIndex].line} at column: {lexemes[addRes.rightIndex].column}\n",
            ...
            if (addRes.node!=null)
            {
                ...
                if (addOps(addRes.rightIndex))
                {
                    ...
                    else
                    {
                        return new NoTermReturn
                        {
                            error =$"Expected term at line {lexemes[addRes.rightIndex].line} at column: {lexemes[addRes.rightIndex].column}\n",
                            rightIndex = addRes.rightIndex+1,
                            node = _node,
                        };
                    }
            ...
            if(termRes.node!=null)
            {
                ...
                if (multOps(termRes.rightIndex))
                {
                    ...
                    else
                    {
                        return new NoTermReturn
                        {
                            error =$"Expected factor at line {lexemes[termRes.rightIndex].line} at column: {lexemes[termRes.rightIndex].column}\n",
        ...
        static public NoTermReturn Call(int left)
        {
            ...
            if (lexemes[left].type == TokenType.Ident)
            {
                ...
                if (lexemes[left+1].type == TokenType.OpenPar)
                {
                    ...
                    if (argsRes.node!=null)
                    {
                        ...
                        else
                        {
                            return new NoTermReturn
                            {
                                error =$"Expected ')' at line {lexemes[argsRes.rightIndex].line} at column: {lexemes[argsRes.rightIndex].column}\n",
                                rightIndex = argsRes.rightIndex+1,
                                node = _node,
                            };
                        }
                    ...
                    else
                    {
                        return new NoTermReturn
                        {
                            error =$"Expected args at line {lexemes[left+2].line} at column: {lexemes[left+2].column}\n",
                            rightIndex = left+3,
                            node = _node,
                        };
                    }
                ...
                else
                {
                    return new NoTermReturn
                    {
                        error =$"Expected '(' at line {lexemes[left+1].line} at column: {lexemes[left+1].column}\n",
                        rightIndex = left+2,
                        node = _node,
                    };
                }
            ...
            else
            {
                return new NoTermReturn
                {
                    error =$"Expected Identifier at line {lexemes[left].line} at column: {lexemes[left].column}\n",
                    rightIndex = left+1,
                    node = _node,
                };
            }
            ...
            if (expressionRes.node!=null)
            {
                ...
                if (lexemes[left].type == TokenType.Comma)
                {
                    ...
                    else
                    {
                        return new NoTermReturn
                        {
                            error =$"Expected ArgList at line {lexemes[left].line} at column: {lexemes[left].column}\n",
                            rightIndex = left+1,
                            node = _node,
                        };
                    }
        ...
        static public bool addOps(int left)
        {
            return lexemes[left].type == TokenType.AddOp;
        }

        static public bool multOps(int left)
        {
            return lexemes[left].type == TokenType.MulOp;
        }
        static public bool relOps(int left)
        {
            // RelOp -> <= | < | > | >= | == | !=
