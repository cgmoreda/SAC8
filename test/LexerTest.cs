...
public class LexerTest
{
    ...
    public void scan1()
    {
        ...
        Assert.True(expect.Count==found.Count, $"{found[0]}");
        for (int i = 0; i<found.Count; i++)
        {
            Assert.True(expect[i]==found[i], $"error in{i}'th token: expected {expect[i]} but found {found[i]}");
        }
    }
    ...
    public void scan2()
    {
        string line1 = "صحيح رقم1 = 5;";
        string line2 = "صحيح احمد[5] = {0,1,2,3,4};";
        string input = line1+'\n'+line2;
        List<Lexeme> expect = new List<Lexeme>()
        {
            new Lexeme() { type = TokenType.num_, value = "صحيح", line = 0, column = 0 },
        ...
        List<Lexeme> found = Lexer.scan(input);
        Assert.True(expect.Count==found.Count, $"expected size: {expect.Count} || found size{found.Count}:: {found[0]}");
        for (int i = 0; i<found.Count; i++)
        {
            Assert.True(expect[i]==found[i], $"error in{i}'th token: expected {expect[i]} but found {found[i]}");
        }
    ...
    {
        string line1 = "صحيح رقم1 = 5;";
        string line2 = "بينما (رقم1 <= 5 )";
        string line3 = "رقم 1 = رقم1 + 1+2;";
        string input = line1+'\n'+line2+'\n'+line3+'\n';
        List<Lexeme> expect = new List<Lexeme>()
        {
            // Lexemes for line1
            ...
            new Lexeme() { type = TokenType.LogOP, value = "<=", line = 1, column = 13 },
            new Lexeme() { type = TokenType.Number, value = "5", line = 1, column = 16 },
            new Lexeme() { type = TokenType.ClosePar, value = ")", line = 1, column = 18 },

            // Lexemes for line3
            new Lexeme() { type = TokenType.Ident, value = "رقم", line = 2, column = 0 },
            new Lexeme() { type = TokenType.Number, value = "1", line = 2, column = 4 },
            new Lexeme() { type = TokenType.equal_, value = "=", line = 2, column = 6 },
            new Lexeme() { type = TokenType.Ident, value = "رقم1", line = 2, column = 8 },
            new Lexeme() { type = TokenType.AddOp, value = "+", line = 2, column = 13 },
            new Lexeme() { type = TokenType.Number, value = "1", line = 2, column = 14 },
            new Lexeme() { type = TokenType.AddOp, value = "+", line = 2, column = 15 },
            new Lexeme() { type = TokenType.Number, value = "2", line = 2, column = 16 },
            new Lexeme() { type = TokenType.Simecolon, value = ";", line = 2, column = 17 }
        };
    ...
    {
        string line1 = "صحيح رقم1 = 5;";
        string line2 = "اذا (رقم1 <= 5 )";
        string line3 = "رقم 1 = رقم1 + 1+2;";
        string line4 = "اخر";
        string line5 = "رقم 1 = رقم1 + 1+2;";
        string input = line1+'\n'+line2+'\n'+line3+'\n'+line4+'\n'+line5;
        List<Lexeme> expect = new List<Lexeme>()
        {
            // Lexemes for line1
            ...
            // Lexemes for line2
            new Lexeme() { type = TokenType.if_, value = "اذا", line = 1, column = 0 },
            new Lexeme() { type = TokenType.OpenPar, value = "(", line = 1, column = 6 },
            new Lexeme() { type = TokenType.Ident, value = "رقم1", line = 1, column = 7 },
            new Lexeme() { type = TokenType.LogOP, value = "<=", line = 1, column = 13 },
            new Lexeme() { type = TokenType.Number, value = "5", line = 1, column = 16 },
            ...
            new Lexeme() { type = TokenType.else_, value = "اخر", line = 3, column = 0 },
            // lexems for line 5
            new Lexeme() { type = TokenType.Ident, value = "رقم", line = 4, column = 0 },
            new Lexeme() { type = TokenType.Number, value = "1", line = 4, column = 4 },
            new Lexeme() { type = TokenType.equal_, value = "=", line = 4, column = 6 },
            new Lexeme() { type = TokenType.Ident, value = "رقم1", line = 4, column = 8 },
            new Lexeme() { type = TokenType.AddOp, value = "+", line = 4, column = 13 },
            new Lexeme() { type = TokenType.Number, value = "1", line = 4, column = 14 },
            new Lexeme() { type = TokenType.AddOp, value = "+", line = 4, column = 15 },
            new Lexeme() { type = TokenType.Number, value = "2", line = 4, column = 16 },
            new Lexeme() { type = TokenType.Simecolon, value = ";", line = 4, column = 17 },
        };
